...
- Wenn Sie die Steuerung per Entität aktivieren, sind zwei weitere Optionen verfügbar:
  - **Automatische Reaktivierung**: Reaktiviert die Steuerungsentität automatisch, wenn alle von der Automatisierung verwalteten Leuchten ausgeschaltet werden.
  - **Automatische Deaktivierung bei Farbe**: Deaktiviert die Steuerungsentität automatisch, sobald eine der verwalteten Leuchten in den Farbmodus wechselt. Da die Automatisierung nur mit weißem Licht arbeitet, ist dies ein Zeichen, dass Sie die Kontrolle übernehmen und die automatischen Anpassungen deaktivieren möchten. Sie können die Steuerungsentität anschließend manuell, über eine andere Automatisierung oder durch Aktivierung der automatischen Reaktivierung wieder einschalten.
...
Wenn eine Steuerungsentität verwendet wird, stoppt die Anpassung automatisch, sobald die Entität deaktiviert wird, und nimmt sie wieder auf, wenn sie reaktiviert wird. In diesem Fall gibt es keine Verzögerung — die richtigen Werte werden sofort gesendet, mit einer sanften Progression über 10 Sekunden. Optional kann die Steuerungsentität automatisch reaktiviert werden, wenn die Leuchten ausgeschaltet werden, und automatisch deaktiviert werden, sobald eine der verwalteten Leuchten in den Farbmodus wechselt.
